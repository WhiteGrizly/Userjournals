...
SC_BEGIN UJ_BLOGGER_LINK
   global $uj_blog;
   return "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?blogger.".$uj_blog["userjournals_userid"]."'>".UJ90."</a>";
SC_END
...
SC_BEGIN UJ_BLOGGER_MENU_LINK
   ...
   //if ($row = getx_user_data($uj_blog["userjournals_userid"])) {
   if ($row = e107::user($uj_blog["userjournals_userid"])) {
      return "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?blogger.".$uj_blog["userjournals_userid"]."'>".$row["user_name"]."</a><br/>".e107::getDate()->convert_date($uj_blog["userjournals_timestamp"], "short");
   }
   return "";
SC_END
...
SC_BEGIN UJ_BLOG_LINK
   global $uj_blog;
   return "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?blog.".$uj_blog["userjournals_id"]."'>".UJ48."</a>";
SC_END
...
SC_BEGIN UJ_BLOG_MOOD
   ...
   if (strlen($uj_blog["userjournals_mood"]) > 0) {
      $text = "<img src='".e_PLUGIN_ABS."userjournals/images/".$uj_blog["userjournals_mood"].".gif' alt='*'/>";
   }
   return $text;
SC_END
...
SC_BEGIN UJ_BLOG_EDIT_LINK
   ...
   if ($uj_blog["userjournals_userid"] == USERID) {
      $text .= "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?edit.".$uj_blog["userjournals_id"]."'>".UJ4."</a>";
   }
   return $text;
SC_END
...
SC_BEGIN UJ_BLOG_DELETE_LINK
   ...
   if ($uj_blog["userjournals_userid"] == USERID || ADMIN) {
      $text .= "<a href='#' onclick='UJConfirmDelete(\"".UJ60."\", \"".e_PLUGIN_ABS."userjournals/userjournals.php?delete.".$uj_blog["userjournals_id"]."\");'>".UJ19."</a>";
   }
   return $text;
SC_END
...
SC_BEGIN UJ_BLOG_REPORT_LINK
   ...
   if (USERID && e107::pref('userjournals', 'userjournals_report_blog')) {
      $text .= "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?report.".$uj_blog["userjournals_id"]."'>".UJ101."</a>";
   }
   return $text;
SC_END
...
SC_BEGIN UJ_BLOG_BLOGGER_LINK
   ...
   return "<a href='".e_PLUGIN_ABS."userjournals/userjournals.php?blogger.".$uj_blog["userjournals_userid"]."'>".$user["user_name"]." ".UJ1."</a>";
SC_END
...
SC_BEGIN UJ_MENU_READER
   ...
   $text = "";
   $plugPrefs = e107::pref('userjournals');
